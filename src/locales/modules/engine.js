...
export default {
  ...
  chatHealthStartGateway: _('启动 Gateway', 'Start Gateway', '啟動 Gateway'),
  ...
  hermesProfileConfigure: _('配置模型', 'Configure model', '配置模型'),
  hermesProfileConfigureTitle: _('配置 Profile 模型：{name}', 'Configure profile model: {name}', '配置 Profile 模型：{name}'),
  hermesProfileProviderLabel: _('服务商', 'Provider', '服務商'),
  hermesProfileModelLabel: _('模型', 'Model', '模型'),
  hermesProfileModelUnset: _('未配置', 'Not configured', '未配置'),
  hermesProfileModelRequired: _('服务商和模型不能为空', 'Provider and model are required', '服務商和模型不能為空'),
  hermesProfileModelSaved: _('Profile "{name}" 模型已保存', 'Model saved for profile "{name}"', 'Profile "{name}" 模型已儲存'),
  hermesProfileModelSaveFailed: _('模型保存失败', 'Failed to save model', '模型儲存失敗'),
