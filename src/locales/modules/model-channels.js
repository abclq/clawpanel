...
export default {
  ...
  desc: _('一处维护模型接入配置（地址、密钥、模型列表），一键同步到 OpenClaw、Hermes、DeepSeek Harness 和晴辰助手。', 'Maintain model access (base URL, API key, models) in one place and sync it to OpenClaw, Hermes, DeepSeek Harness, and the assistant.', '一處維護模型接入設定（位址、金鑰、模型清單），一鍵同步到 OpenClaw、Hermes、DeepSeek Harness 和晴辰助手。'),
  ...
  how2: _('点「同步到…」把渠道推送给 OpenClaw / Hermes / DeepSeek Harness / 晴辰助手，无需再各处重复配置', 'Click "Sync to…" to push the channel to OpenClaw / Hermes / DeepSeek Harness / the assistant — no more duplicate setup', '點「同步到…」把渠道推送給 OpenClaw / Hermes / DeepSeek Harness / 晴辰助手，無需再各處重複設定'),
  ...
  deleteConfirm: _('删除渠道「{name}」？已同步到 OpenClaw / Hermes / DeepSeek Harness / 助手的配置不会被删除。', 'Delete channel "{name}"? Configs already synced to OpenClaw / Hermes / DeepSeek Harness / the assistant will not be removed.', '刪除渠道「{name}」？已同步到 OpenClaw / Hermes / DeepSeek Harness / 助手的設定不會被刪除。'),
