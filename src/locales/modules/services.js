...
export default {
  ...
  gatewayDiagnosticsTitle: _('Gateway 启动诊断', 'Gateway startup diagnostics'),
  gatewayDiagnosticsHint: _('下面保留了本次启动返回信息和最新日志，可直接判断配置、端口、Node.js 或 CLI 问题。', 'The startup response and latest logs are preserved below to help identify configuration, port, Node.js, or CLI issues.'),
  gatewayDiagnosticsReason: _('【启动返回】', '[Startup response]'),
  gatewayDiagnosticsErrorLog: _('【错误日志 gateway.err.log】', '[Error log: gateway.err.log]'),
  gatewayDiagnosticsOutputLog: _('【运行日志 gateway.log】', '[Output log: gateway.log]'),
  gatewayDiagnosticsGuardianLog: _('【守护日志 guardian.log】', '[Guardian log: guardian.log]'),
  gatewayDiagnosticsNoLogs: _('本次启动没有产生可读取日志，请进入“系统诊断”检查 CLI、Node.js、配置文件与端口。', 'This attempt produced no readable logs. Open Diagnostics to check the CLI, Node.js, configuration, and port.'),
